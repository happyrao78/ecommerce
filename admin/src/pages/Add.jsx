...
// // 2. Add fetchAttributes function
...
// // 4. Add this handler for attribute selection
// const handleAttributeChange = (e) => {
//     setSelectedAttributeId(e.target.value);
//     setSelectedAttributeValues([]); // Reset values when changing attribute
// };

// // 5. Add function to toggle attribute values
// const toggleAttributeValue = (value) => {
...
//             if (selectedAttributeId && selectedAttributeValues.length > 0) {
...
//                 {/* Add this before the final submit button */}
                
//                {/* Add this before the submit button */}
// <div className="w-full mt-4">
//     <p className='mb-2 font-medium'>Product Attribute (Optional)</p>
//     {loading ? (
//         <div className="animate-pulse h-10 bg-gray-200 rounded-md w-full max-w-[500px]"></div>
//     ) : (
//         <>
//             <select 
//                 className='w-full max-w-[500px] px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 mb-3' 
...
//             {selectedAttributeId && (
//                 <div className='mt-3'>
//                     <p className='mb-2 font-medium'>Select Values</p>
//                     <div className='flex flex-wrap gap-3 max-w-[500px]'>
//                         {attributes.find(attr => attr._id === selectedAttributeId)?.attributeValues.map((value, index) => (
//                             <div
//                                 key={index}
