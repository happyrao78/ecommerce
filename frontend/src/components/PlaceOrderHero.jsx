  ...
  return (
    <div className=''>
        <div className='relative h-[150px] sm:[150px] lg:h-[300px] w-screen bg-gray-200 overflow-hidden'>
            ...
            <h1 className='text-black text-2xl sm:text-2xl lg:text-4xl font-medium'>Check Out</h1>
            <Breadcrumbs paths={[{href:'/',label:'Home'},{href:'/place-order',label:'Place Order'}]}/></div>
